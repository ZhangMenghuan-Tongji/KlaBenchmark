...
# PBertKla loads weights via model.resolve_pretrained_dump_path() (Hugging Face Hub by default).
DEFAULT_LOCAL_MODEL_DUMP_DIR = str(_REPO_ROOT / "external_models" / "proteinBERT")
